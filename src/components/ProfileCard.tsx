        ...
        >
            <div className="relative aspect-square w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 transform transition-transform duration-300 group-hover:-translate-y-1">
                    ...
                    <p className="text-rose-300 text-xs mb-1.5 font-medium">{profile.location}</p>
                    ...
                    <div className="grid grid-cols-4 gap-1.5" onClick={(e) => e.stopPropagation()}>
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 text-rose-400 group-hover/btn:text-white">
                        ...
                        <button
                            ...
                            className="flex flex-col items-center justify-center btn-primary p-2 rounded-xl transition-all active:scale-90 shadow-lg shadow-rose-500/20" title="Like"
                        >
