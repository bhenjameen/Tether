...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-t-0 border-x-0 rounded-none px-6 py-4">
            <div className="max-w-7xl mx-auto flex justify-between items-center w-full">
                ...
                <div className="hidden md:flex gap-8 items-center font-medium">
                    <Link href="/" className="flex items-center gap-2 hover:text-rose-400 transition-colors">
                    ...
                    <div className="flex items-center gap-6 border-l border-white/10 pl-8 ml-2">
                        <button
                            ...
                            className="flex items-center gap-2 hover:text-rose-400 transition-colors group"
                        >
                            <div className="p-2 rounded-lg bg-white/5 group-hover:bg-rose-500/20 transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                        ...
                        {!isLoggedIn ? (
                            <Link href="/discover" className="flex items-center gap-2 hover:text-rose-400 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                            ...
                            <Link href="/notifications" className="flex items-center gap-2 hover:text-rose-400 transition-colors relative group">
