        ...
        <div className={`min-h-screen flex flex-col relative transition-opacity duration-500 ${isLoggingIn ? 'opacity-50' : 'opacity-100'}`}>
            ...
            <div className="absolute inset-0 z-0">
                <div
                    ...
                    style={{
                        backgroundImage: 'url("https://images.unsplash.com/photo-1543807535-eceef0bc65c9?q=80&w=2000&auto=format&fit=crop")',
                    }}
                />
                <div className="absolute inset-0 bg-gradient-to-br from-slate-950/90 via-rose-950/70 to-slate-950/90 mix-blend-multiply" />
                <div className="absolute inset-0 bg-gradient-to-tr from-rose-500/20 via-transparent to-amber-500/20" />
            </div>
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <div className="flex-1 flex flex-col w-full max-w-7xl mx-auto">
                    <div className="flex-1 flex flex-col lg:flex-row pt-32 lg:pt-32 pb-6 lg:pb-0">
                        ...
                        <div className="hidden lg:flex lg:w-[65%] flex-col px-6 lg:pt-0 lg:pb-12 py-12 border-r border-white/5 bg-slate-900/10">
                            <div className="mb-8">
                        ...
                        <div className="w-full lg:w-[35%] px-6 py-4 sm:p-6 lg:pt-0 lg:px-6 lg:pb-6 flex flex-col items-center justify-start min-h-[calc(100vh-5rem)] lg:min-h-0">
                            {/* Sticky Wrapper for Desktop - centers math physically below nav space and sticks instantly */}
                            <div className="relative w-full lg:sticky lg:top-[calc(50vh+4rem)] lg:-translate-y-1/2 lg:mt-[calc(50vh-4rem)] lg:w-full lg:px-8 flex flex-col items-center justify-center">
                                <div className={`w-full max-w-[420px] lg:max-w-[320px] glass-panel p-8 lg:px-6 lg:py-4 shadow-2xl border border-white/10 transition-all duration-300 ${shouldShake ? 'animate-shake border-rose-500/50 shadow-rose-500/10' : ''} ${error ? 'scale-[1.02]' : 'scale-100'}`}>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        <div>
                                            <label className="block text-sm lg:text-xs font-medium text-slate-300 mb-2.5">Email</label>
                                            <input
                                                type="email"
                                                value={email}
                                                onChange={(e) => setEmail(e.target.value)}
                                                className="w-full bg-slate-900/50 border border-slate-700 rounded-xl px-5 py-3.5 lg:px-4 lg:py-2.5 text-base lg:text-sm focus:outline-none focus:border-rose-500 transition-colors placeholder:text-slate-600 outline-none text-white"
                                        ...
                                        <div>
                                            <div className="flex justify-between mb-2.5">
                                                <label className="block text-sm lg:text-xs font-medium text-slate-300">Password</label>
                                                <Link href="#" className="text-xs lg:text-[11px] text-rose-400 hover:text-rose-300">
                                                    Forgot?
                                                </Link>
                                            </div>
                                            <input
                                        ...
                                        <button
                                            ...
                                            className="w-full btn-primary py-4 lg:py-3 font-bold text-base lg:text-sm disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                                        >
                                            {isLoggingIn ? 'Signing In...' : 'Sign In'}
                                        </button>
                                    </form>

                                    <div className="mt-8 lg:mt-4 text-center">
                                        <p className="text-slate-500 text-[11px] lg:text-[10px] mb-6 lg:mb-4 uppercase tracking-widest">Or continue with</p>
