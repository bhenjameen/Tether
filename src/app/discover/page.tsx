...
function DiscoveryPageContent() {
    ...
    useEffect(() => {
        ...
        if (photo === 'true') setFilterPhotoOnly(true);
    }, [searchParams]);
            ...
            <div className="pt-32 px-4 md:px-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-slate-400 mt-2 text-base md:text-lg">Find your perfect match nearby</p>
                    </div>
                    ...
                    <div className="flex gap-3 relative">
                        ...
                        <div className="relative" ref={filterRef}>
                            ...
                            {showFilters && (
                                <div className="absolute right-0 top-full mt-2 w-80 glass-panel p-5 z-50 shadow-2xl border border-white/10 animate-in fade-in slide-in-from-top-2 duration-200">
                                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Search Filters</h4>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div>
                                            <label className="text-[10px] font-bold text-slate-500 uppercase block mb-2">Gender</label>
                                        ...
                                        <div>
                                            <label className="text-[10px] font-bold text-slate-500 uppercase block mb-2">Age Range</label>
                                        ...
                                        <div>
                                            <label className="text-[10px] font-bold text-slate-500 uppercase block mb-2">Location</label>
                                            <select
                ...
                <div className="mb-12 animate-in fade-in duration-500">
                    <h2 className="text-xl font-semibold mb-4 text-slate-200">Featured Moments</h2>
                    <Stories />
                </div>
                ...
                {currentProfiles.length > 0 ? (
                    ...
                    <div className="py-20 text-center glass-panel border-dashed">
                        <p className="text-slate-400">No matches found for your criteria.</p>
                        <button
                            onClick={() => {
                ...
                {totalPages > 1 && (
                    <div className="mt-20 flex items-center justify-center gap-8 border-t border-white/5 pt-8">
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 rounded-xl border border-white/10 transition-all font-medium text-sm ${currentPage === 1
                                ? 'opacity-30 cursor-not-allowed text-slate-500'
                                : 'hover:bg-white/5 text-slate-200 active:scale-95'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 rounded-xl border border-white/10 transition-all font-medium text-sm ${currentPage === totalPages
                                ? 'opacity-30 cursor-not-allowed text-slate-500'
                                : 'hover:bg-white/5 text-slate-200 active:scale-95'
                                }`}
                        >
