                    ...
                    <div className="flex-1 flex flex-col lg:flex-row pt-32 lg:pt-32 pb-6 lg:pb-0">
                        ...
                        <div className="w-full lg:w-[35%] px-6 py-4 sm:p-6 lg:pt-0 lg:px-6 lg:pb-6 flex flex-col items-center justify-start min-h-[calc(100vh-5rem)] lg:min-h-screen">
                            ...
                            <div className="relative w-full lg:sticky lg:top-[55vh] lg:-translate-y-1/2 lg:mt-[calc(55vh-8rem)] lg:w-full lg:px-8 flex flex-col items-center justify-center">
                                <div className={`w-full max-w-[420px] lg:max-w-[330px] glass-panel p-5 lg:px-4 lg:py-2 shadow-2xl border border-white/10 transition-all duration-300 ${shouldShake ? 'animate-shake border-rose-500/50 shadow-rose-500/10' : ''} ${error ? 'scale-[1.02]' : 'scale-100'}`}>
