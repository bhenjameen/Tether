                ...
                <div className="space-y-3">
                    {notifications.length > 0 ? (
                        notifications.map(notification => (
                            <div
                                key={notification.id}
                                className={`glass-panel p-4 flex gap-4 items-start transition-all hover:border-violet-500/30 group ${!notification.isRead ? 'bg-violet-500/5 border-violet-500/20' : ''}`}
                            >
                                <div className="relative">
                                    ...
                                    />
                                    {!notification.isRead && (
                                        <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-violet-500 rounded-full border-2 border-slate-950 shadow-lg" />
                                    )}
                                </div>
